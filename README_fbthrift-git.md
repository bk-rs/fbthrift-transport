...
```
git clone git@github.com:facebook/fbthrift.git fbthrift-git
cd fbthrift-git
git checkout master
git fetch origin
...
sed -i 's/^version = "0.0.1+unstable"$/version = "0.0.4+c18333c"/' Cargo.toml
...
git commit -a -m "Release 0.0.4+c18333c"
